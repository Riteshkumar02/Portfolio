  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <button style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center" }} className="btn btn-github" onClick={() => window.location.href = "https://github.com/Riteshkumar02"}>
            <svg
